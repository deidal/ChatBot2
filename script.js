...
var greetings = [
    'Hi there, it\'s ChatBot :-)', 'Hello! I\'m ChatBot', 'Hi, I\'m ChatBot!', 'Hey there, how are you? I\'m ChatBot', 'Hey, ChatBot here!'
...
var chatBotMessages = [
    ...
    , 'What is your favorite color? Mine is yellow',  'What are you up to these days?', 'What is your favorite book?',
    'What is your favorite movie?', 'Where is the last place you traveled to?', 'What is the weather like where you are?'
]
...
function grabName() {
    let userInput = document.getElementsById("input").value; 
...
function chatBotMessage() {
    ...
    } else if (chatbotCount > 5 && chatbotCount <10) {
